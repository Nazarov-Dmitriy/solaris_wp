...
if (isset($_POST['submit-login'])) {
    // header('Location: http://solaris-wp/cabinet-user');
    exit("<meta http-equiv='refresh' content='0; url= /cabinet-user'>");
...
<section class="wrap-container" id="intro">
    <div class="intro">
        ...
        <div class="intro__form-container">
            <form method="POST" class="intro__form">
                <input type="text" class="intro__input p2" name="login" value="" placeholder="Логин">
                <input type="text" class="intro__input p2" name="password" value="" placeholder="Пароль">
                <button type="submit" class="btn" name="submit-login" value="22">Воити в кабинет</button>
                <button class="intro__form-btn btn-text">Забыли пароль?</button>
