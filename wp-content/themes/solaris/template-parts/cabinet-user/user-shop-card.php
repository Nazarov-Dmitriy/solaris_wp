<section class="shop-card">
    <div class="card">
        <div class="card-header">
            <img class="card-img" src="<?php echo get_template_directory_uri() ?>/assets/image/cabinet/image.png" alt="Изображение отсутствует">
            <h2 class="card-header-text">Сертификат АНТИДВОЙКА</h2>
            <div class="card-price-wraper">
                <p class="card-price">200</p>
                <svg class="card-icon" width="41" height="44" viewBox="0 0 41 44" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="card-text">
            ...
            <p class="card-text-word p1">Сертификат «Антидвойка» - <br>это уникальный документ, предоставляющий ученикам школы возможность аннулировать любые полученные двойки по любым предметам. Этот сертификат служит своеобразным спасательным кругом для тех, кто допустил ошибку и стремится её исправить. Он помогает восстановить уверенность в собственных силах и продолжить обучение с новыми возможностями.
                <br>Кроме того, сертификат «Антидвойка» мотивирует учеников к усердной учёбе и достижению лучших результатов. Зная, что у них есть возможность исправить ошибки и улучшить свои оценки, ученики становятся более ответственными и целеустремлёнными в своём обучении. Это способствует формированию позитивного отношения к образованию и развитию навыков самоконтроля.
                <br>В заключение, сертификат «Антидвойка» является важным инструментом для поддержки и мотивации учеников школы. Он помогает им преодолевать трудности, исправлять ошибки и улучшать свою успеваемость, способствуя формированию успешной образовательной траектории.
            </p>
        </div>
